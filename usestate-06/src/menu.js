...
const Menu = () => {
    ...
    const selectedDishes = menu.filter(dish => selectedCategory === "All" || dish.category === selectedCategory)
    return (
        <div className="menu">
            <h1>Our Menu</h1>
            <Filters
